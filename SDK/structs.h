...
{
	DWORD_PTR Fire;                         // 0x0000
	byte bLoopedFire;                    // 0x0008
	unsigned char UnknownData00[0x7];   
	DWORD_PTR Reload;                       // 0x0010
	DWORD_PTR CharacterGripBlendspace;      // 0x0018
	DWORD_PTR CharacterLHGripBlendspace;    // 0x0020
	DWORD_PTR CharacterFire;                // 0x0028
	DWORD_PTR CharacterFireCycle;           // 0x0030
	DWORD_PTR CharacterFireSelector;        // 0x0038
	DWORD_PTR CharacterReloadTactical;      // 0x0040
	DWORD_PTR CharacterReloadCharge;        // 0x0048
	DWORD_PTR CharacterReloadByOneStart;    // 0x0050
	DWORD_PTR CharacterReloadByOneStop;     // 0x0058
	DWORD_PTR CharacterReloadByOneSingle;   // 0x0060
	DWORD_PTR WeaponReloadTactical;         // 0x0068
	DWORD_PTR WeaponReloadCharge;           // 0x0070
	float ReloadDurationTactical;        // 0x0078
	float ReloadDurationCharge;          // 0x007C
	float ReloadDurationStart;           // 0x0080
	float ReloadDurationLoop;            // 0x0084
	float ReloadDurationMagOut;          // 0x0088
	float FireCycleDelay;                // 0x008C
	float FireCycleDuration;             // 0x0090
	byte bCycleAfterLastShot;            // 0x0094
	byte bCycleDuringReload;             // 0x0095
	unsigned char UnknownData01[0x2];
	DWORD_PTR ShotCameraShake;              // 0x0098
	DWORD_PTR ShotCameraShakeIronsight;     // 0x00A0
	DWORD_PTR ShotCameraShakeADS;           // 0x00A8
	DWORD_PTR CycleCameraAnim;              // 0x00B0
	float RecoilKickADS;                 // 0x00B8
	Vector MagDropLinearVelocity;       // 0x00BC
	Vector MagDropAngularVelocity;      // 0x00C8
};*/
...
{
	float DeviationBase;
	float DeviationBaseAim;
	float DeviationBaseADS;
	float DeviationRecoilGain;
	float DeviationRecoilGainAim;
	float DeviationRecoilGainADS;
	float DeviationMax;
	float DeviationMinMove;
	float DeviationMaxMove;
	float DeviationMoveMultiplier;
	float DeviationMoveMinReferenceVelocity;
	float DeviationMoveMaxReferenceVelocity;
	float DeviationStanceStand;
	float DeviationStanceCrouch;
	float DeviationStanceProne;
	float DeviationStanceJump;
};*/
