#pragma once
enum class EFiringMode : unsigned char
{
	Normal = 0,
	Burst = 1,
	FullAuto = 2,
...
enum class EWeaponGripLeftHand : unsigned char
{
...
enum class EThrownWeaponType : unsigned char
{
	Thrown_Grenade = 0,
	Thrown_Molotov = 1,
	Thrown_Other = 2,
...
enum class EWeaponClass : unsigned char
{
	Class_Pistol = 0,
	Class_SMG = 1,
	Class_Rifle = 2,
...
enum class EWeaponReloadMethod : unsigned char
{
	Magazine = 0,
	OneByOne = 1,
	OneByOneAndClip = 2,
...
enum class EStanceMode : unsigned char
{
	STANCE_None = 0,
	STANCE_Stand = 1,
	STANCE_Crouch = 2,
...
enum class ETeamVehicleType : int
{
