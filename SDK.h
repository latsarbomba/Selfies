...
public:
	...
	int32_t iDroppedItemGroupCount; //0x02E0
	...
	char pad_09F0[96]; //0x09F0
	float Punch_Damage; //0x0A50
	float PunchHeavy_Damage; //0x0A54
	char pad_0A58[16]; //0x0A58
	float Punch_Distance; //0x0A68
	float PunchHeavy_Distance; //0x0A6C
	float Punch_Radius; //0x0A70
	float PunchHeavy_Radius; //0x0A74
	float Punch_InitialLocation; //0x0A78
	char pad_0A7C[72]; //0x0A7C
	float Sprint_MaxSpeed; //0x0AC4
	float Sprint_MinSpeed; //0x0AC8
	char pad_0ACC[728]; //0x0ACC
	float Stand_RunningSpeedModifier; //0x0DA4
	float Stand_SprintingSpeedModifier; //0x0DA8
	float Stand_SprintingBigGunModifier; //0x0DAC
	float Stand_SprintingRifleModifier; //0x0DB0
	float Stand_SprintingSmallGunMOdifier; //0x0DB4
	float Crouch_RunningSpeedModifier; //0x0DB8
	float Crouch_SprintingSpeedModifier; //0x0DBC
	float Prone_RunningSpeedModifier; //0x0DC0
	float Prone_SprintingSpeedModifier; //0x0DC4
	char pad_0DC8[692]; //0x0DC8
	float Health; //0x107C
